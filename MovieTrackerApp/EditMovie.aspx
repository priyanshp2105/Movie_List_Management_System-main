<%@ Page Title="Edit Movie" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditMovie.aspx.cs" Inherits="MovieTrackerApp.EditMovie" %>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <asp:DropDownList ID="ddlWatchStatus" runat="server" CssClass="form-select">
                                    <asp:ListItem Text="Unwatched" Value="Unwatched"></asp:ListItem>
